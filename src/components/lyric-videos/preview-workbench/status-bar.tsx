...
export function StatusBar() {
  ...
  return (
    <footer className="status-bar flex h-[44px] shrink-0 items-center justify-center border-t border-[var(--editor-line)] bg-[var(--editor-panel)] px-[16px]">
      {blockingError ? (
        <div className="flex items-center gap-[10px] text-[13px] font-[700] text-[var(--editor-danger)]">
          ...
          <button
            ...
            className="inline-flex items-center gap-1 rounded-[5px] border border-[var(--editor-danger)] px-2 py-1 disabled:cursor-not-allowed disabled:opacity-60"
          >
        ...
        <div className="flex items-center gap-[12px] text-[13px] font-[700] text-[var(--editor-muted)]">
          ...
          <button
            ...
            className="flex h-[28px] w-[180px] items-center justify-center gap-[8px] rounded-[8px] bg-[var(--editor-accent)] text-[14px] font-[800] text-[var(--editor-accent-ink)] hover:bg-[var(--editor-accent-hover)] disabled:cursor-not-allowed disabled:opacity-60"
          >
